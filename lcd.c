...
********************************************************************************
* Summary: draws a pixel at the coordinates (x,y)
* Returns:
*  Nothing
*******************************************************************************/
void lcd_draw_pixel(
  ...
  uint16_t fColor
    ...
    Crystalfontz128x128_SetDrawFrame(x, y, x + 1, y + 1);
...
********************************************************************************
* Summary: draws a line starting at the coordinates (x,y) for a length of len.
* Returns:
*  Nothing
*******************************************************************************/
void lcd_draw_line_horizontal(
  uint16_t x,
  uint16_t y,
  uint16_t len,
  uint16_t fColor
)
{
    ...
    Crystalfontz128x128_SetDrawFrame(x, y, x + len, y);
...
/*******************************************************************************
* Function Name: lcd_draw_line_vertical
********************************************************************************
* Summary: draws a line starting at the coordinates (x,y) for a length of len.
* Returns:
*  Nothing
*******************************************************************************/
void lcd_draw_line_vertical(
  uint16_t x,
  uint16_t y,
  uint16_t len,
  uint16_t fColor
)
{
    ...
    // Set the boundry of the image to draw
    Crystalfontz128x128_SetDrawFrame(x, y, x, y + len);
...
void lcd_draw_rectangle(
  uint16_t x,
  uint16_t y,
  uint16_t width_pixels, //xlen
  uint16_t height_pixels, //ylen
  uint16_t fColor
)
{
    uint16_t i,j;
    ...
    // Account for a height that is an even number
